  ...
  return (
    <div className="absolute bottom-3 right-3 z-[1000] w-64 bg-gray-950/95 border border-gray-700 rounded-xl shadow-2xl overflow-hidden backdrop-blur-sm">
      ...
      <div className="p-4 space-y-3">
        ...
        <div className="flex items-start gap-2 bg-emerald-900/15 border border-emerald-800/50 rounded-lg p-2.5">
          <Bot className="w-3.5 h-3.5 text-emerald-400 shrink-0 mt-0.5" />
          <div className="text-[10px] leading-relaxed">
            <span className="text-emerald-400 font-semibold block mb-0.5">توصية «دليل» — وكيل التوجيه</span>
            <span className="text-emerald-100/90">
              {getCellRecommendation(cell.value, cell.nearestLandmark)}
            </span>
          </div>
        </div>
